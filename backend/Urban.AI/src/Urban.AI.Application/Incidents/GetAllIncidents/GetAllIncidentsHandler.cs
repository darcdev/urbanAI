...
internal sealed class GetAllIncidentsHandler : IQueryHandler<GetAllIncidentsQuery, List<IncidentResponse>>
{
    #region Constants
    ...
    {
        var incidents = await _incidentRepository.GetAllIncidentsAsync(cancellationToken);
